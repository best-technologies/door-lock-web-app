...
Create a new user account in the system. A unique userId will be auto-generated based on role and current date. A secure password will be automatically generated and sent to the user via email along with their account details.

**Endpoint**: `POST /api/v1/admin/users-management`

**Note**: A secure 12-character password is automatically generated and sent to the user via email. The user can use this password to sign in to the system.
...
| `employeeId` | string | No | Employee ID (if not provided, can be set later) |
